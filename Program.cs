...
public class Program
{
    ...
    public static void Main(string[] args)
    {
        ...
        GetAllDirsAndFiles(dirName, settings.GetAllDirsAndFiles!); 
    }
    ...
    public static void GetAllDirsAndFiles(string dirName, string methodSetting)
    {
            ...
            foreach (DirectoryInfo dir in dirs)
            {
                if (methodSetting.Equals("Consider"))
                {
                    if (IsAllow(dir.FullName, "Consider.txt"))
                    {
                        ...
                        GetAllDirsAndFiles(dir.FullName, methodSetting);
                    }
                }
            ...
            foreach (FileInfo file in files)
            {
                if (methodSetting.Equals("Consider"))
                {
                    if (IsAllow(file.FullName, "Consider.txt"))
                    {
                        ...
                        GetAndWriteTextFromFile(file.FullName);
                    }
                }
    ...
    public static void GetAndWriteTextFromFile(string path)
    {
